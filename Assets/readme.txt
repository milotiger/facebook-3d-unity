...
Add the PlayerControl script on the player game object. Add The ThirdPersonOrbitCam script on the camera. Add the CharacterController to the player animator controller. 
Attach a capsule collider, and a rigidbody component to the player. 
Also certify to drop the player game object on the public reference of the camera script. 
An image for the crosshair in aim mode is also necessary for this script to work properly.
